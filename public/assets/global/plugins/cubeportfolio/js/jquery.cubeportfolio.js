/*!
 * Cube Video - Responsive jQuery Grid Plugin
 *
 * version: 3.5.2 (11 February, 2016)
 * require: jQuery v1.7+
 *
 * Copyright 2013-2016, Mihai Buricea (http://scriptpie.com/cubevideo/live-preview/)
...
(function($, window, document, undefined) {
    ...
    function CubeVideo(obj, options, callback) {
        /*jshint validthis: true */
        var t = this,
            initialCls = 'cbp',
            children;

        if ($.data(obj, 'cubevideo')) {
            throw new Error('cubevideo is already initialized. Destroy it before initialize again!');
        }

        // attached this instance to obj
        $.data(obj, 'cubevideo', t);

        // extend options
        t.options = $.extend({}, $.fn.cubevideo.options, options);
        ...
        if (t.options.caption) {
            if (t.options.caption !== 'expand' && !CubeVideo.private.modernBrowser) {
        ...
        t.plugins = $.map(CubeVideo.plugins, function(pluginName) {
            return pluginName(t);
        });
    ...
    $.extend(CubeVideo.prototype, {
        ...
        resizeEvent: function() {
            ...
            CubeVideo.private.initResizeEvent({
                instance: t,
                fn: function() {
                    var tt = this;
        ...
        resizeMainContainer: function() {
            ...
            if (t.height !== undefined) {
                if (CubeVideo.private.modernBrowser) {
                    t.$obj.one(CubeVideo.private.transitionend, function() {
        ...
        addItems: function(items, callback) {
            ...
            if (CubeVideo.private.modernBrowser) {
                items.last().one(CubeVideo.private.animationend, function() {
            ...
            t.loadImages(items, function() {
                ...
                if (t.elems) {
                    CubeVideo.public.showCounter.call(t.obj, t.elems);
                }
     ...
     */
    $.fn.cubevideo = function(method, options, callback) {
        return this.each(function() {
            if (typeof method === 'object' || !method) {
                return CubeVideo.public.init.call(this, method, options);
            } else if (CubeVideo.public[method]) {
                return CubeVideo.public[method].call(this, options, callback);
            }

            throw new Error('Method ' + method + ' does not exist on jquery.cubevideo.js');
        });
    };

    CubeVideo.plugins = {};
    $.fn.cubevideo.constructor = CubeVideo;
})(jQuery, window, document);

(function($, window, document, undefined) {
    'use strict';

    var CubeVideo = $.fn.cubevideo.constructor;
...
jQuery.fn.cubevideo.options = {
     ...
     *          - if this option is `false` Cube Video will adjust the items
...
(function($, window, document, undefined) {
    ...
    CubeVideo.private = {
        ...
        /**
         * Check if cubevideo instance exists on current element
         */
        checkInstance: function(method) {
            var t = $.data(this, 'cubevideo');

            if (!t) {
                throw new Error('cubevideo is not initialized. Initialize it before calling ' + method + ' method!');
            }
...
(function($, window, document, undefined) {
    ...
    CubeVideo.public = {
        ...
        init: function(options, callback) {
            new CubeVideo(this, options, callback);
        },
        ...
        destroy: function(callback) {
            var t = CubeVideo.private.checkInstance.call(this, 'destroy');

            t.triggerEvent('beforeDestroy');

            // remove data
            $.removeData(this, 'cubevideo');
            ...
            // remove resize event
            CubeVideo.private.destroyResizeEvent(t);
        ...
        filter: function(param, callback) {
            var t = CubeVideo.private.checkInstance.call(this, 'filter'),
                expression;
            ...
            if ($.isFunction(param)) {
                ...
                if(expression === undefined) {
                    throw new Error('When you call cubevideo API `filter` method with a param of type function you must return the blocks that will be visible.');
                }
            } else {
        ...
        showCounter: function(elems, callback) {
            var t = CubeVideo.private.checkInstance.call(this, 'showCounter');
        ...
        appendItems: function(els, callback) {
            var t = CubeVideo.private.checkInstance.call(this, 'appendItems'),
...
(function($, window, document, undefined) {
    ...
    // pt slider ca as extinde pe CubeVideo.prototype la fiecare initializare
    $.extend(CubeVideo.prototype, {
        ...
        updateSliderPosition: function() {
            ...
            if (CubeVideo.private.modernBrowser) {
                t.$ul[0].style[CubeVideo.private.transform] = 'translate3d(' + value + 'px, 0px, 0)';
            } else {
            ...
            function dragEnd(e) {
                ...
                if (pos !== 0) {
                    ...
                    requestAnimationFrame(function() {
                        ...
                        t.$ul.one(CubeVideo.private.transitionend, afterDragEnd);
                    });
                } else {
                    afterDragEnd.call(t);
                }
...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.filterLayout = function() {
        ...
        t.blocksOn2On.addClass('cbp-item-on2on')
            .each(function(index, el) {
                var data = $(el).data('cbp');
                el.style[CubeVideo.private.transform] = 'translate3d(' + (data.leftNew - data.left) + 'px, ' + (data.topNew - data.top) + 'px, 0)';
            });
        ...
        if (t.blocksOn2Off.length) {
            t.blocksOn2Off.last().data('cbp').wrapper.one(CubeVideo.private.animationend, animationend);
        } else if (t.blocksOff2On.length) {
            t.blocksOff2On.last().data('cbp').wrapper.one(CubeVideo.private.animationend, animationend);
        } else {
            animationend();
        }
        ...
        function animationend() {
            t.blocks.removeClass('cbp-item-on2off cbp-item-off2on cbp-item-on2on')
                .each(function(index, el) {
                    ...
                    el.style[CubeVideo.private.transform] = '';
                });
    ...
    CubeVideo.plugins.animationClassic = function(parent) {
        if (!CubeVideo.private.modernBrowser || $.inArray(parent.options.animationType, ['boxShadow', 'fadeOut', 'flipBottom', 'flipOut', 'quicksand', 'scaleSides', 'skew']) < 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.filterLayout = function() {
            ...
            t.blocksOn.removeClass('cbp-item-off')
                .each(function(index, el) {
                    ...
                    if (t.options.animationType === 'sequentially') {
                        data.wrapper[0].style[CubeVideo.private.animationDelay] = (index * 60) + 'ms';
                    }
                });

            if (t.blocksOn.length) {
                t.blocksOn.last().data('cbp').wrapper.one(CubeVideo.private.animationend, animationend);
            } else if (t.blocksOnInitial.length) {
                t.blocksOnInitial.last().data('cbp').wrapper.one(CubeVideo.private.animationend, animationend);
            } else {
                animationend();
            }
        ...
        function animationend() {
            ...
            if (t.options.animationType === 'sequentially') {
                t.blocksOn.each(function(index, el) {
                    $(el).data('cbp').wrapper[0].style[CubeVideo.private.animationDelay] = '';
                });
            }
    ...
    CubeVideo.plugins.animationClone = function(parent) {
        if (!CubeVideo.private.modernBrowser || $.inArray(parent.options.animationType, ['fadeOutTop', 'slideLeft', 'sequentially']) < 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.filterLayout = function() {
        ...
        items.children('.cbp-item-wrapper').each(function(index, el) {
            el.style[CubeVideo.private.animationDelay] = (index * 50) + 'ms';
        });
        ...
        requestAnimationFrame(function() {
            ...
            t.blocksOn.removeClass('cbp-item-off')
                .each(function(index, el) {
                    ...
                    data.wrapper[0].style[CubeVideo.private.animationDelay] = (index * 50) + 'ms';
                });
            ...
            if (onLength === 0 && offLength === 0) {
                ...
                items.last().children('.cbp-item-wrapper').one(CubeVideo.private.animationend, animationend);
            } else {
                t.blocksOn.last().data('cbp').wrapper.one(CubeVideo.private.animationend, animationend);
            }
    ...
    CubeVideo.plugins.animationCloneDelay = function(parent) {
        if (!CubeVideo.private.modernBrowser || $.inArray(parent.options.animationType, ['3dflip', 'flipOutDelay', 'foldLeft', 'frontRow', 'rotateRoom', 'rotateSides', 'scaleDown', 'slideDelay', 'unfold']) < 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.filterLayout = function() {
        ...
        requestAnimationFrame(function() {
            ...
            if (t.blocksOn.length) {
                t.$ul.one(CubeVideo.private.animationend, animationend);
            } else if (t.blocksOnInitial.length) {
                $(ulClone).one(CubeVideo.private.animationend, animationend);
            } else {
                animationend();
            }
    ...
    CubeVideo.plugins.animationWrapper = function(parent) {
        if (!CubeVideo.private.modernBrowser || $.inArray(parent.options.animationType, ['bounceBottom', 'bounceLeft', 'bounceTop', 'moveLeft']) < 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubeVideo.plugins.captionExpand = function(parent) {
...
(function($, window, document, undefined) {
    ...
    function Plugin(parent) {
        ...
        parent.registerEvent('initEndWrite', function() {
            parent.blocksOn.each(function(index, el) {
                el.style[CubeVideo.private.animationDelay] = (index * parent.options.displayTypeSpeed) + 'ms';
            });

            parent.$obj.addClass('cbp-displayType-bottomToTop');

            // get last element
            parent.blocksOn.last().one(CubeVideo.private.animationend, function() {
                parent.$obj.removeClass('cbp-displayType-bottomToTop');

                parent.blocksOn.each(function(index, el) {
                    el.style[CubeVideo.private.animationDelay] = '';
                });
    ...
    CubeVideo.plugins.displayBottomToTop = function(parent) {
        if (!CubeVideo.private.modernBrowser || parent.options.displayType !== 'bottomToTop' || parent.blocksOn.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    function Plugin(parent) {
        ...
        parent.registerEvent('initEndWrite', function() {
            parent.obj.style[CubeVideo.private.animationDuration] = parent.options.displayTypeSpeed + 'ms';

            parent.$obj.addClass('cbp-displayType-fadeIn');

            parent.$obj.one(CubeVideo.private.animationend, function() {
                parent.$obj.removeClass('cbp-displayType-fadeIn');

                parent.obj.style[CubeVideo.private.animationDuration] = '';
    ...
    CubeVideo.plugins.displayFadeIn = function(parent) {
        if (!CubeVideo.private.modernBrowser || (parent.options.displayType !== 'lazyLoading' && parent.options.displayType !== 'fadeIn') || parent.blocksOn.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubeVideo.plugins.displayFadeInToTop = function(parent) {
        if (!CubeVideo.private.modernBrowser || parent.options.displayType !== 'fadeInToTop' || parent.blocksOn.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    CubeVideo.plugins.displaySequentially = function(parent) {
        if (!CubeVideo.private.modernBrowser || parent.options.displayType !== 'sequentially' || parent.blocksOn.length === 0) {
            return null;
        }
...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.registerFilter = function() {
        ...
        t.filters.each(function(index, el) {
            ...
            parent.$obj.cubevideo('showCounter', items);
            ...
            items.on('click.cbp', function() {
                ...
                if (parent.defaultFilter !== filterJoin) {
                    // filter the items
                    parent.$obj.cubevideo('filter', filterJoin);
                }
            });
        });
    };
    ...
    CubeVideo.plugins.filters = function(parent) {
...
(function($, window, document, undefined) {
    ...
    CubeVideo.plugins.inlineSlider = function(parent) {
        return new Plugin(parent);
    };
})(jQuery, window, document);
...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.removeLazy = function(el, dataSrc, parentNode) {
        ...
        if (parentNode) {
            if (CubeVideo.private.modernBrowser) {
                $(el).one(CubeVideo.private.transitionend, function() {
                    parentNode.removeClass(t.options.loadingClass);
                });
            } else {
                parentNode.removeClass(t.options.loadingClass);
    ...
    CubeVideo.plugins.lazyLoad = function(parent) {
        return new Plugin(parent);
    };
})(jQuery, window, document);
...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.click = function() {
        ...
        t.loadMore.on('click.cbp', function(e) {
            ...
            $.ajax({
                ...
                t.parent.$obj.cubevideo('appendItems', items.substring(start, end), function() {
    ...
    CubeVideo.plugins.loadMore = function(parent) {
...
(function($, window, document, undefined) {
    ...
    var popup = {
         ...
         * @param cubevideo = cubevideo instance
         * @param type =  'lightbox' or 'singlePage'
         */
        init: function(cubevideo, type) {
            var t = this,
                currentBlock;

            // remember cubevideo instance
            t.cubevideo = cubevideo;
            ...
            t.options = t.cubevideo.options;

            if (type === 'lightbox') {
                t.cubevideo.registerEvent('resizeWindow', function() {
                    t.resizeImage();
                });
            }
            ...
            if (type === 'singlePageInline') {
                ...
                t.cubevideo.registerEvent('resizeGrid', function() {
                    if (t.isOpen) {
                ...
                if (t.options.singlePageInlineDeeplinking) {
                    ...
                    $.each(links, function(index, link) {
                        t.cubevideo.blocksOn.each(function(index1, el) {
                    ...
                    if (currentBlock) {
                        t.cubevideo.registerEvent('initFinish', function() {
                            t.openSinglePageInline(t.cubevideo.blocksOn, currentBlock[0]);
                        }, true);
                    }
                }
                ...
                if (t.options.singlePageDeeplinking) {
                    ...
                    if (currentBlock) {
                        ...
                        if (gallery) {
                            ...
                            t.cubevideo.blocksOn.each(function(index, el) {
                                var item = $(el);
        ...
        createMarkup: function() {
            ...
            if (CubeVideo.private.browser === 'ie8') {
                t.bg = $('<div/>', {
        ...
        destroy: function() {
            ...
            t.cubevideo.$obj.off('click.cbp', t.options.singlePageInlineDelegate);
            t.cubevideo.$obj.off('click.cbp', t.options.lightboxDelegate);
            t.cubevideo.$obj.off('click.cbp', t.options.singlePageDelegate);

            t.cubevideo.$obj.removeClass('cbp-popup-isOpening');

            t.cubevideo.$obj.find('.cbp-item').removeClass('cbp-singlePageInline-active');
        ...
        openSinglePage: function(blocks, currentBlock) {
            ...
            if (t.cubevideo.singlePageInline && t.cubevideo.singlePageInline.isOpen) {
                t.cubevideo.singlePageInline.close();
            }
            ...
            t.navigationMobile = $();
            t.wrap.one(CubeVideo.private.transitionend, function() {
                $('html').css({
                    overflow: 'hidden',
                    marginRight: window.innerWidth - $(document).width()
                });
                ...
                if (t.options.singlePageStickyNavigation) {
                    ...
                    if (CubeVideo.private.browser === 'android' || CubeVideo.private.browser === 'ios') {
                        // wrap element
            ...
            if (CubeVideo.private.browser === 'ie8' || CubeVideo.private.browser === 'ie9') {
                // make the navigation sticky
                if (t.options.singlePageStickyNavigation) {
                    t.navigationWrap.width(t.wrap[0].clientWidth);
        ...
        openSinglePageInline: function(blocks, currentBlock, fromOpen) {
            ...
            if (t.isOpen) {
                ...
                if ((t.dataArray[t.current].url !== currentBlock.getAttribute('href')) || (t.current !== tempCurrent)) {
                    t.cubevideo.singlePageInline.close('open', {
                        blocks: blocks,
            ...
            t.wrap.insertBefore(t.cubevideo.wrapper);
            ...
            if (t.options.singlePageInlineInFocus) {
                ...
                var goToScroll = t.cubevideo.$obj.offset().top + t.top - 100;
            ...
            t.cubevideo.$obj.addClass('cbp-popup-singlePageInline-open');
        ...
        resizeSinglePageInline: function() {
            ...
            t.height = ((t.top === 0) || (t.top === t.cubevideo.height)) ? t.wrap.outerHeight(true) : t.wrap.outerHeight(true) - t.options.gapHorizontal;
            ...
            t.blocksToMove.each(function(index, el) {
                if (CubeVideo.private.modernBrowser) {
                    el.style[CubeVideo.private.transform] = 'translate3d(0px, ' + t.height + 'px, 0)';
                } else {
                    el.style.marginTop = t.height + 'px';
                }
            });

            t.cubevideo.obj.style.height = t.cubevideo.height + t.height + 'px';
        },
        ...
        revertResizeSinglePageInline: function() {
            ...
            t.cubevideo.obj.style.height = t.cubevideo.height + 'px';
        },
        ...
        updateSinglePageIsOpen: function() {
            ...
            // trigger public event
            t.cubevideo.$obj.trigger('updateSinglePageStart.cbp');

            // instantiate slider if exists
            selectorSlider = t.content.find('.cbp-slider');
            if (selectorSlider) {
                selectorSlider.find('.cbp-slider-item').addClass('cbp-item');
                t.slider = selectorSlider.cubevideo({
                    layoutMode: 'slider',
                    mediaQueries: [{
                        width: 1,
                        cols: 1
            ...
            // trigger public event
            t.cubevideo.$obj.trigger('updateSinglePageComplete.cbp');
        },
        ...
        updateSinglePageInline: function(html, scripts) {
            ...
            // trigger public event
            t.cubevideo.$obj.trigger('updateSinglePageInlineStart.cbp');
        ...
        singlePageInlineIsOpen: function() {
            ...
            function finishLoading() {
                ...
                // trigger public event
                t.cubevideo.$obj.trigger('updateSinglePageInlineComplete.cbp');
            }

            // wait to load all images
            t.cubevideo.loadImages(t.wrap, function() {
                // instantiate slider if exists
        ...
        isImage: function(el) {
            ...
            t.cubevideo.loadImages($('<div><img src="' + el.src + '"></div>'), function() {
        ...
        close: function(method, data) {
            ...
            function finishClose() {
                ...
                t.cubevideo.$obj.removeClass('cbp-popup-singlePageInline-open cbp-popup-singlePageInline-close');

                if (method === 'promise') {
                    if ($.isFunction(data.callback)) {
                        data.callback.call(t.cubevideo);
                    }
                }
            ...
            if (t.type === 'singlePageInline') {
                if (method === 'open') {
                    ...
                    t.wrap.removeClass('cbp-popup-singlePageInline-ready');
                    t.cubevideo.$obj.addClass('cbp-popup-singlePageInline-close');
                    t.cubevideo.$obj.find('.cbp-item').removeClass('cbp-singlePageInline-active');
        ...
        preloadNearbyImages: function() {
            ...
            for (var i = arr.length - 1; i >= 0; i--) {
                if (t.dataArray[arr[i]].type === 'isImage') {
                    t.cubevideo.checkSrc(t.dataArray[arr[i]].src);
                }
            }
        }
    };
    ...
    CubeVideo.plugins.popUp = function(parent) {
        return new Plugin(parent);
    };
})(jQuery, window, document);
...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.runEvent = function(el) {
        ...
        t.parent.$obj.cubevideo('filter', function(blocks) {
    ...
    CubeVideo.plugins.search = function(parent) {
...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.sliderMarkup = function() {
        ...
        if (t.options.drag && CubeVideo.private.modernBrowser) {
            t.dragSlider();
        }
    };
    ...
    CubeVideo.plugins.slider = function(parent) {
